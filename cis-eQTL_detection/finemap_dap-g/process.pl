...
open FILE, "zcat $expr_file | "; ##mean expr_file gziped.
...
while(<FILE>){
   ...
   print CMD "perl /home/shuli.liu/commands/commands_for_RNA_seq_2/eQTL/dap-g_eQTL/assemble.pl $geno_vcf $tissue/$gene.cis_snp.bed $tissue/$gene.expr $covar_file > $tissue/$gene.sbams.dat\n";

...
All_eQTL<-read.table(paste0("All_association.",tissue,".mlma.eQTL.txt"),header=T)
...
library("data.table")
cross_mappability<-read.table("~/cross_mappability.1Mb.genebody.txt")
##cross mappability file is generated as stated in https://github.com/battle-lab/crossmap/blob/master/compute_crossmap.md
...
write.table(Trans_eQTL_filter, "Trans_eQTL_FDR_0.05_filter.txt",col.names=T, row.names=F, quote=F, sep="\t")
